...
if __name__ == '__main__':
    logger = utils.init_logger('tbi.PreProcessor', True)
    ...
    for file_name in file_names:
        ...
        os.system('3dresample -dxyz 1.0 1.0 1.0 -orient RPI -prefix {0} -inset {1}'.format(out2file, out1file))
        ...
        os.system('antsRegistrationSyN.sh -d 3 -n 40 -f {0} -m {1} -o {2}_normalized -t a'.format(args.mni_file, out3file, output))
